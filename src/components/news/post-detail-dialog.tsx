  ...
  return (
    <Dialog open={open} onOpenChange={(o) => { if (!o) onClose(); }}>
      <DialogContent className="max-w-2xl p-0 overflow-hidden flex flex-col max-h-[90vh]">
        <DialogTitle className="sr-only">{localPost.title}</DialogTitle>
        <div className="overflow-y-auto">
          ...
          <div className="px-5 pt-5 pb-3">
            <div className="flex items-start justify-between gap-2">
              ...
              <div className="flex items-center gap-1 shrink-0">
                ...
                <Button
                  ...
                  onClick={() => onToggleSave(localPost.id)}
                >
                  {isSaved ? (
            ...
            <h2 className="text-lg font-bold mt-3 leading-snug">
              {localPost.title}
            </h2>
          ...
          {/* Reaction summary */}
          <div className="px-5 mt-3 flex items-center justify-between text-xs text-muted-foreground">
            <div className="flex items-center gap-3">
